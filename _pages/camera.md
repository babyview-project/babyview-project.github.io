...
The BabyView camera is designed to collect high-resolution, at-home egocentric video data from children 6 - 30 months of age. The first version of the camera consisted of a rotated GoPro Hero Black Bones attached to a lightweight baby safety helmet using a custom 3D-printed mount, powered by a rechargeable 9V battery. In our updated build we use a GoPro HERO model.
...
However, the GoPro Hero Bones has been discontinued, and we have created an updated build for ongoing data collection; this camera is the newest release of the GoPro HERO model, which offers some advantages – including an integrated battery, which makes the build considerably simpler.  
<div style="text-align: center;">
